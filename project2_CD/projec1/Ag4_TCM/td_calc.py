...
#gpaw -P 64 python td_calc.py -- --gpw ./work_7202365/7202365.gpw --mode lcao --gauge length --kick x --outdir ./work_7202365
#gpaw -P 16 python td_calc.py -- --gpw ./work_Ag4/Ag4.gpw --mode lcao --gauge length --kick x --outdir ./work_Ag4
...
def run_lcao(gpw, outdir, kick, gauge, dt_as, nsteps, origin, origin_shift):
    ...
    WaveFunctionWriter(td, os.path.join(outdir, f'wf-{real_gauge}_{kick}.ulm'))
    if origin == 'COM':
...
if __name__ == "__main__":
    ...
    ap.add_argument("--nsteps", type=int, default=1100, help="步数 steps")
