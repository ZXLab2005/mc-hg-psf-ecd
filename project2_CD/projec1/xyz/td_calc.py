...
#$ gpaw -P 72 python td_calc.py -- --gpw ./work_Ag78/Ag78-full-cluster.gpw   --mode lcao --gauge length --kick y --dt_as 10 --nsteps 2000 --outdir ./work_Ag78
...
def run_lcao(gpw, outdir, kick, gauge, dt_as, nsteps, origin, origin_shift):
    ...
    td = LCAOTDDFT(gpw, txt=os.path.join(outdir, f'td-{kick}.out'),parallel=dict(sl_auto=True, domain=16, augment_grids=True)
    )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--nsteps", type=int, default=2000, help="步数 steps")
