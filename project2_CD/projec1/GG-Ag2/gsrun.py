...
# gpaw -P 24 python gsrun.py -- --xyz ./GG-Ag2.xyz   --mode lcao --basis dzp --nbands 500 --outdir ./work_GG-Ag2
...
def main(xyz, mode, basis, nbands, h, vacuum, outdir):
    ...
    calc = GPAW(
        ...
        parallel=dict(sl_auto=True, band=6, domain=4,augment_grids=True),
    )
