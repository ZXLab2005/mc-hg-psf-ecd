...
# -*- coding: utf-8 -*-
"""
Gaussian-pulse RT-TDDFT for Ag4:
 - drive with GaussianPulse
 - record electric dipole, magnetic dipole, and Mulliken atomic charges

Usage (example):
gpaw -P 64 python td_gaussian_ag4.py   --gpw ./Ag4.gpw   --outdir ./work_Ag4_gauss   --E0_va 1e-3 --omega_eV 4.73 --sigma_fs 4.0 --t0_fs 8.0   --dir x --dt_as 20 --nsteps 1600 --origin COM
"""
...
def main():
    ...
    parallel = {'sl_auto': False, 'band': 2, 'domain': 32, 'augment_grids': True}
