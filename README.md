...
Prepare molecular or cluster structure files
Load the corresponding dataset or descriptors
Run the relevant spectrum-related script(s)
Analyze predicted ECD spectra and mechanism-related outputs
